...
class Religious extends Component{
    ...
    componentDidMount(){
        axios.get("https://helpinghand-backend.herokuapp.com/event/display/religious",this.state.config)
        .then((response)=>{
            this.setState({
        ...
        .catch((error)=>{
            toast('ERROR DISPLAYING RELIGIOUS EVENT')
...
render(){
    ...
    return(
        <ul class="sort-destination isotope gallery-items" data-sort-id="gallery">
            ...
            return(
            <li class="col-md-4 col-sm-6 grid-item event-grid-item Religious format-standard">
