...
class Charitable extends Component{
    ...
    componentDidMount(){
        axios.get("https://helpinghand-backend.herokuapp.com/event/display/charitable",this.state.config)
        .then((response)=>{
            this.setState({
...
render(){
    ...
    return(
        <ul class="sort-destination isotope gallery-items" data-sort-id="gallery">
            ...
            return(
            <li class="col-md-4 col-sm-6 grid-item event-grid-item Charitable format-standard">
