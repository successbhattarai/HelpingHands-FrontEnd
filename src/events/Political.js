...
class Political extends Component{
    ...
    componentDidMount(){
        axios.get("https://helpinghand-backend.herokuapp.com/event/display/political",this.state.config)
        .then((response)=>{
            this.setState({
        ...
        .catch((error)=>{
            toast('ERROR DISPLAYING POLITICAL EVENT')
...
render(){
    ...
    return(
        <ul class="sort-destination isotope gallery-items" data-sort-id="gallery">
            ...
            return(
            <li class="col-md-4 col-sm-6 grid-item event-grid-item Political format-standard">
