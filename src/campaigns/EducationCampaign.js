...
class EducationCampaign extends Component{
    ...
    componentDidMount(){
        axios.get("https://helpinghand-backend.herokuapp.com/campaign/display/education",this.state.config)
        .then((response)=>{
            this.setState({
        ...
        .catch((error)=>{
            toast('ERROR DISPLAYING EDUCATIONAL CAMPAIGN')
